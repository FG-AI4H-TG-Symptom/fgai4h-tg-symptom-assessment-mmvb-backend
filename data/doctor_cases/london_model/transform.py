...
def create_concept(concept_name):
    return {
        "name": concept_name,
        "id": concept_names_to_ids[concept_name],
    }
    ...
    for row_index, row in enumerate(csvreader):
        ...
        if row_index > 0 and row[0] != "":
            ...
            current_case['caseData'] = {
                "caseId": "human_doctor_case_london_model_spreadsheet111D40_case_" + str(case_index),
                "profileInformation": {
                    "age": age,
                    "biologicalSex": sex,
                },
                ...
                "metaData": {
                    "description": "A case created by a human doctor (the London 2019 model cases)",
                    "case_creator": row[1],
